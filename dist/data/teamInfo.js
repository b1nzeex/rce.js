...
function parseTeamInfo(teamInfoResponse, players = []) {
    ...
    for (const line of lines) {
        ...
        const teamHeaderMatch = line.match(regularExpressions_1.RegularExpressions.TeamInfoTeamHeader);
        if (teamHeaderMatch) {
        ...
        const playerMatch = line.match(regularExpressions_1.RegularExpressions.TeamInfoPlayer);
